        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Modifier l'article</p>
            </div>
          </div>
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 rounded-lg bg-red-600/10 text-red-400 text-sm font-bold hover:bg-red-600/20 transition-colors flex items-center gap-2"
            >
